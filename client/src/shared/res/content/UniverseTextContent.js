const universeShortDescribe = `The Universe is practically everything. From space, time, and their contents, which include planets, stars, galaxies, to all other forms of matter, and energy. Everything is part of the universe, and the universe is part of everything.`;

const universeAge = `We now know that the universe is 13,800,000,000 years old, that’s 13.8 billion. That is a very long time.`;

const bigBangShortDescribe = `The big bang is how astronomers explain the way the universe began. It is the idea that the universe began as just a single point, then expanded and stretched to grow as large as it is right now—and it is still stretching!`;
